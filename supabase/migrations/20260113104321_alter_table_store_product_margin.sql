DROP TABLE IF EXISTS public.product_margin_branches CASCADE;

CREATE TABLE public.product_margin_branches (
...
DROP TRIGGER IF EXISTS trg_set_updated_at_product_margin_branches ON public.product_margin_branches;

CREATE TRIGGER trg_set_updated_at_product_margin_branches
BEFORE UPDATE ON public.product_margin_branches
FOR EACH ROW
